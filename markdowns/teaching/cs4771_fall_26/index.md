...
permalink: /teaching/cs4771_fall_26/index
---
...
- Office Hours:
  - Shangtong: Monday, 2:50 PM - 3:30 PM @ Rice 422
  - Amir: Tuesday, 2:00 PM - 3:00 PM @ Rice 442
  - Xinyu: Thursday, 2:00 PM - 3:00 PM @ Rice 442
...
* 1.2 Reproduce Figure 2.6 (parameter study)
...
Everyone has a single chance for an 1-week late submission without any penalty (note that this cannot be used for HW 7.2).
If you want to use this, declare it [here](https://forms.gle/iNN1wtGiFsxrLfr17). **No other hindsight extension is possible unless doctor notes or SDAC notifications are provided.**
