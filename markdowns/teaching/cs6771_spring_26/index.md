...
- Paper Review (60 points): You will read 12 papers / topics (one paper / topic each week starting from the ADD deadline). For each paper / topic, you need to write a summary and ask 3 questions. Each paper review has 5 points. See my email for exact requirements.
