...
\newcommand*{\advisee}[0]{{$^{[\emph{advisee}]}$}}
% \newcommand*{\referees}{}
% \newcommand*{\misc}{}
...
\moveleft.5\hoffset\centerline{422 Rice Hall, 85 Engineer's Way, Charlottesville, VA, 22903, United States} % Your address
\moveleft.5\hoffset\centerline{\href{mailto: shangtong@virginia.edu}{shangtong@virginia.edu}\quad\quad \href{https://shangtongzhang.github.io}{https://shangtongzhang.github.io}}
...
\begin{enumerate}[leftmargin=*]
    \item \cvpaper{arXiv 2023}{Direct Gradient Temporal Difference Learning}{Xiaochi Qian\advisee, \me.}{arXiv:2308.01170, 2023.}{}
    \item \cvpaper{arXiv 2023}{Improving Monte Carlo Evaluation with Offline Data}{Shuze Liu\advisee, \me.}{arXiv:2301.13734, 2023.}{}
    \item \cvpaper{ICML 2023}{On the Convergence of SARSA with Linear Function Approximation}{\me, Remi Tachet des Combes, Romain Laroche.}{\icml{2023}.}{Acceptance rate: 28\%}
    \item \cvpaper{arXiv 2021}{Global Optimality and Finite Sample Analysis of Softmax Off-Policy Actor Critic under State Distribution Mismatch}{\me, Remi Tachet des Combes$^\ddagger$, Romain Laroche$^\ddagger$.}{\jmlr{2022}.}{}
    ...
    \item \cvpaper{arXiv 2020}{A Deeper Look at Discounting Mismatch in Actor-Critic Algorithms}{\me, Romain Laroche, Harm van Seijen, Shimon Whiteson, \\Remi Tachet des Combes.}{\aamas{2022}.}{Acceptance rate: 26\%}
    ...
    \item \cvpaper{Deep RL Workshop at NeurIPS 2021}{StarCraft II Unplugged: Large Scale Offline Reinforcement Learning}{Michael Mathieu$^*$, Sherjil Ozair$^*$, Srivatsan Srinivasan$^*$, Caglar Gulcehre$^*$, \\\me$^*$, Ray Jiang$^*$, Tom Le Paine$^*$, Richard Powell, Konrad Zolna, \\Julian Schrittwieser, David Choi, Petko Georgiev, Daniel Kenji Toyama, \\Aja Huang, Roman Ring, Igor Babuschkin, Timo Ewalds, Mahyar Bordbar, \\Sarah Henderson, Sergio Gomez Colmenarejo, Aaron van den Oord, \\Wojciech M. Czarnecki, Nando de Freitas, Oriol Vinyals.}{arXiv:2308.03526, 2023}{\textbf{Deep RL Workshop at NeurIPS}, 2021}
    ...
    \item
    \cvpaper{ICML 2019}{Distributional Reinforcement Learning for Efficient Exploration}{Borislav Mavrin, \me$^\dag$, Hengshuai Yao, Linglong Kong, \\Kaiwen Wu, Yaoliang Yu}{\icml{2019}.}{Acceptance rate: 22.6\%. \\A short version is accepted as an extended abstract at AAMAS 2019.}
    \item
...
\section{Honours}
\honour{2022}{Runner-Up for the IFAAMAS Victor Lesser Dissertation Award}{}{}{}{}
\honour{2022 - 2027}{Alf Weaver Junior Faculty Fellowship}{University of Virginia}{}{}{}
...
Zhengkun Xiao (2022 - 2023)

\textbf{Undergraduates} \\
Ja-Zhua Cheng (2022 - )

\textbf{Research Interns} \\
Jiuqi Wang (2022 - ) \\
Xiaochi Qian (2022 - )

\textbf{PhD Committees} \\
Ingy ElSayed-Aly (Advised by Prof. Lu Feng at UVA) \\
Sudhir Shenoy (Advised by Prof. Afsaneh Doryab at UVA) \\
Chuanhao Li (Advised by Prof. Hongning Wang at UVA) \\
\emph{Qualification:} \\
Zeyu Mu (Advised by Prof. Brian Park at UVA) \\
Dane Williamson (Advised by Prof. Yangfeng Ji at UVA) \\
Matthew Landers (Advised by Prof. Afsaneh Doryab at UVA) \\
Ethan Harrison Blaser (Advised by Prof. Hongning Wang at UVA)
